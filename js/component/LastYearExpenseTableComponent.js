...
import {
    GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_X,
    GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_Y,
    GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_W_ARRAY,
    GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_H_ARRAY,
    GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_BORDER,
    GAME_SCREEN_LAST_YEAR_EXPENSE_COLOR,
...
export class LastYearExpenseTableComponent {
    constructor(context) {
    ...
    draw() {
        new GridDrawingBuilder(
            ...
            GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_H_ARRAY,
            GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_W_ARRAY)
            .addPercentX(GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_X)
            .addPercentY(GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_Y)
            .addBorderForAll(GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_BORDER, GAME_SCREEN_LAST_YEAR_EXPENSE_COLOR)
            .addBackgroundForFirstRow(GAME_SCREEN_LAST_YEAR_EXPENSE_COLOR)
            .addBackground(GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_H_ARRAY.length - 1, 1, GAME_SCREEN_LAST_YEAR_EXPENSE_COLOR)
            .addText(
                0,
                0,
                "EXPENSES",
