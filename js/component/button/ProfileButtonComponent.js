...
import {
    PROFILE_BUTTON_IMAGE_SRC,
    PROFILE_BUTTON_COMPONENT_PERCENT_Y,
...
export class ProfileButtonComponent {
    ...
    draw() {
        ...
        let y = PROFILE_BUTTON_COMPONENT_PERCENT_Y - (MENU_BUTTON_COMPONENT_PERCENT_R * .85);
    ...
    setBackgroundColor(pressed, x, y) {
        ...
        let expectY = this.context.getHeightPercent(PROFILE_BUTTON_COMPONENT_PERCENT_Y - MENU_BUTTON_COMPONENT_PERCENT_R);
        ...
        if (this.pressed == true && pressed == false) {
            this.context.setScreen(PROFILE_SCREEN);
        }
