...
export const IMAGE_PLAY_PERCENT_X = 77;
export const IMAGE_PLAY_PERCENT_Y = 5;
...
export const IMAGE_FACE_RASPBERRY_PERCENT_X = 38;
export const IMAGE_FACE_RASPBERRY_PERCENT_Y = 5;
...
export const GAME_SCREEN_LIABILITY_PERCENT_Y = 50;
...
export const GAME_SCREEN_REVENUE_PERCENT_X = 83;
...
export const GAME_SCREEN_EXPENSE_PERCENT_X = 83;
export const GAME_SCREEN_EXPENSE_PERCENT_Y = 50;
...
export const GAME_SCREEN_FINANCIALS_PERCENT_X = 37;
export const GAME_SCREEN_FINANCIALS_PERCENT_Y = 3;
export const GAME_SCREEN_FINANCIALS_PERCENT_W = 45;
export const GAME_SCREEN_FINANCIALS_PERCENT_H = 90;
export const GAME_SCREEN_FINANCIALS_PERCENT_BORDER = .2;
export const GAME_SCREEN_FINANCIALS_COLOR = "white";

export const GAME_SCREEN_NEXT_YEAR_BUTTON_PERCENT_X = 64;
export const GAME_SCREEN_NEXT_YEAR_BUTTON_PERCENT_Y = 5;
...
export const GAME_SCREEN_NEXT_YEAR_BUTTON_TEXT_PERCENT_X = 65;
export const GAME_SCREEN_NEXT_YEAR_BUTTON_TEXT_PERCENT_Y = 10.8;
...
export const GAME_SCREEN_PROFILE_PICTURE_PERCENT_X = 38;
export const GAME_SCREEN_PROFILE_PICTURE_PERCENT_Y = 5;
...
export const GAME_SCREEN_LAST_YEAR_REVENUE_PERCENT_Y = 32;
...
export const GAME_SCREEN_LAST_YEAR_EXPENSE_PERCENT_Y = 32;
...
export const GAME_SCREEN_JOB_TITLE_TEXT_PERCENT_X = 52;
export const GAME_SCREEN_JOB_TITLE_TEXT_PERCENT_Y = 20;
export const GAME_SCREEN_JOB_TITLE_TEXT_TYPE = "32pt Helvetica";
export const GAME_SCREEN_JOB_TITLE_TEXT_COLOR = "white";

export const GAME_SCREEN_JOB_TITLE_SALARY_TEXT_PERCENT_X = 52;
export const GAME_SCREEN_JOB_TITLE_SALARY_TEXT_PERCENT_Y = 26;
