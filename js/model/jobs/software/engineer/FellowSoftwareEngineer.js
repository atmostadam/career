...
import { SeniorFellowSoftwareEngineer } from "./SeniorFellowSoftwareEngineer.js";

/** From Google Career Framework. */
export class FellowSoftwareEngineer {
    constructor() {
        this._title = "Fellow Software Engineer";
        this._performanceBonussalary = 1000000;
        this._performanceBonus = 1000000;
        this._stockOptions = 10000000;
