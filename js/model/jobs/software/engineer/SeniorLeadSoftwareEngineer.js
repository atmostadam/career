...
import { PrincipalSoftwareEngineer } from "./PrincipalSoftwareEngineer.js";

/** https://www.salary.com/research/salary/benchmark/software-engineer-v-salary/atlanta-ga */
export class SeniorLeadSoftwareEngineer {
    constructor() {
        this._title = "Senior Lead Software Engineer";
        this._salary = 165513;
        this._performanceBonus = 40000;
        this._stockOptions = 20000;
        this._jobLevel = 6;
