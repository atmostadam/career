...
import { LeadSoftwareEngineer } from "./LeadSoftwareEngineer.js";

/** https://www.salary.com/research/salary/benchmark/software-engineer-iii-salary/atlanta-ga */
export class SoftwareEngineerIII {
    constructor() {
        this._title = "Level III";
        this._salary = 120020;
        this._performanceBonus = 15000;
